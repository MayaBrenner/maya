      ...
      <div className="grid gap-16 lg:grid-cols-[1fr_380px]">
        ...
        <div>
          ...
          <h1 className="mb-8" style={{ fontFamily: "var(--font-display)" }}>
            From tactile to digital — with the same precision.
          </h1>
          ...
          <ScrollReveal delay={0.1}>
            <h2
              className="mt-16 mb-8 text-2xl font-medium"
            ...
            <div className="space-y-6">
              {TIMELINE.map(({ year, event }) => (
                <div key={year} className="flex gap-8">
                  <span className="label w-12 shrink-0 pt-0.5">{year}</span>
          ...
          <ScrollReveal delay={0.15}>
            <h2
              className="mt-16 mb-6 text-2xl font-medium"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Tools
            </h2>
        ...
        <ScrollReveal delay={0.05} className="lg:pt-20">
          <div className="rounded-2xl border border-[--color-border] bg-[--color-surface] p-8">
            ...
            <p className="mb-6 text-sm text-[--color-muted]">Product Designer · Tel Aviv, Israel</p>
